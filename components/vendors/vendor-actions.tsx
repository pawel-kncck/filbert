...
export function VendorActions({ vendor, companyId, isAdmin }: Props) {
  ...
  const handleShowInvoices = () => {
    router.push(`/purchases?search=${encodeURIComponent(vendor.name)}`)
  }
