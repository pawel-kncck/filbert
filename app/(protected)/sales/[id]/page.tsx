...
export default async function SalesInvoiceDetailPage({ params, searchParams }: Props) {
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="text-right">
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Data wystawienia</p>
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            <div>
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Netto</p>
            ...
            <div>
              <p className="text-sm text-zinc-600 dark:text-zinc-400">Brutto</p>
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
          ...
          <dl className="mt-4 grid gap-4 sm:grid-cols-3">
            <div>
              <dt className="text-sm text-zinc-600 dark:text-zinc-400">Waluta</dt>
              <dd className="mt-1 text-sm font-medium text-zinc-900 dark:text-white">
                {invoice.currency}
              </dd>
            </div>
            <div>
              <dt className="text-sm text-zinc-600 dark:text-zinc-400">Źródło</dt>
              <dd className="mt-1 text-sm font-medium text-zinc-900 dark:text-white">
                {invoice.source === 'manual' ? 'Ręczne' : invoice.source === 'demo' ? 'Demo' : 'KSeF'}
              </dd>
            </div>
            <div>
              <dt className="text-sm text-zinc-600 dark:text-zinc-400">Dodano</dt>
              <dd className="mt-1 text-sm font-medium text-zinc-900 dark:text-white">
